...
const serverHost = process.env.SERVER_HOST || 'Aaravcool25.aternos.me';
const serverPort = parseInt(process.env.SERVER_PORT || '64892', 10);
const botUsername = process.env.BOT_USERNAME || 'Aarav_AFK_BOT';
